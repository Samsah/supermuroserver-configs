...
{
	PrecacheModel("models/props/cs_office/computer.mdl", true);
...
public OnMapStart()
{
	g_iLaserMaterial = PrecacheModel("materials/sprites/purplelaser1.vmt");
...
stock SpawnTriggerMultipleInBox(iZoneIndex)
{
	...
	SetEntityModel(iEnt, "models/props/cs_office/computer.mdl");
