...
public Client_PlayerChangeName(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	CreateTimer(10.0, Client_DecreaseCount, userid);
...
public Action:Client_DecreaseCount(Handle:timer, any:userid)
{
...
bool:Client_HasValidName(client)
{
	...
	if ( f_iSize < 1 || f_sName[0] == '&' || IsCharSpace(f_sName[0]) || IsCharSpace(f_sName[f_iSize-1]) )
		return false;
