...
public Menu_DisplayKickVote(iClient)
{
	...
	if(!CheckCommandAccess(iClient, "sm_votemenu", 0) || !CheckCommandAccess(iClient, "sm_votekick_flag", 0))
	{
...
public Menu_DisplayBanVote(iClient)
{
	...
	if(!CheckCommandAccess(iClient, "sm_votemenu", 0) || !CheckCommandAccess(iClient, "sm_voteban_flag", 0))
	{
		ReplyToCommand(iClient, "[SM] %t.", "No Access");
		return;
	}
...
public Menu_DisplayMapVote(iClient)
{
	...
	if(!CheckCommandAccess(iClient, "sm_votemenu", 0) || !CheckCommandAccess(iClient, "sm_votemap_flag", 0))
	{
		ReplyToCommand(iClient, "[SM] %t.", "No Access");
		return;
	}
...
public Menu_DisplayMuteVote(iClient)
{
	...
	if(!CheckCommandAccess(iClient, "sm_votemenu", 0) || !CheckCommandAccess(iClient, "sm_votemute_flag", 0))
	{
		ReplyToCommand(iClient, "[SM] %t.", "No Access");
		return;
	}
