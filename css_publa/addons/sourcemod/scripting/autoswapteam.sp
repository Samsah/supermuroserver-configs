...
new String: soundFileRound[128];
new String: soundFileAlert[128];
new String: soundFileSwap[128];
...
public OnMapStart()
{
	...
	{
		PrecacheSound(soundFileRound,true);
	}
