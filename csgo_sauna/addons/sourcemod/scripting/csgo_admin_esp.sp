...
public OnPlayerEvents(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (IsValidClient(client))
	{
		...
		else if (CheckCommandAccess(client, "csgo_admin_esp", ADMFLAG_GENERIC))
		{
...
public Action:Command_ToggleESP(client, args)
{
	...
	if (GetConVarBool(AdminESP) && CheckCommandAccess(client, "csgo_admin_esp_cmd", ADMFLAG_GENERIC))
	{
